...
java -mx6g -cp "$scriptdir/stanford-parser.jar:" edu.stanford.nlp.parser.lexparser.LexicalizedParser -tLPP edu.stanford.nlp.parser.lexparser.ArabicTreebankParserParams -tokenized $ARGS -escaper edu.stanford.nlp.trees.international.arabic.IBMArabicEscaper -maxLength 120 -MAX_ITEMS 500000 -writeOutputFiles -outputFormat "wordsAndTags,penn" -outputFormatOptions "xml,markHeadNodes,removeTopBracket,includePunctuationDependencies" $scriptdir/arabicFactored.ser.gz $*
